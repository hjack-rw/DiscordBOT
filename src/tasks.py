...
time_trigger = {"game_reset":    time(hour=4,  minute=0,  second=0, tzinfo=zoneinfo.ZoneInfo("Africa/Cairo")),   # UTC+2 - 03:00 - exact
                "morning":       time(hour=7,  minute=0,  second=0, tzinfo=zoneinfo.ZoneInfo("Europe/London")),  # UTC+1 - 08:00 - exact
                "weekly_cards":  time(hour=16, minute=59, second=0, tzinfo=zoneinfo.ZoneInfo("Africa/Cairo")),   # UTC+2 - 16:00 - exact
                "housecup":      time(hour=19, minute=0,  second=0, tzinfo=zoneinfo.ZoneInfo("Africa/Cairo")),   # UTC+2 - 18:00 - 24 h early
                "club_events":   time(hour=19, minute=25, second=0, tzinfo=zoneinfo.ZoneInfo("Europe/London")),  # UTC+1 - 20:30 - 5 min early
                "game_midnight": time(hour=23, minute=0,  second=0, tzinfo=zoneinfo.ZoneInfo("Africa/Cairo")),   # UTC+2 - 23:00 - 1 h early
                "midnight":      time(hour=23, minute=0,  second=0, tzinfo=zoneinfo.ZoneInfo("Europe/London")),} # UTC+1 - 24:00 - 1 h early
